...
namespace Coins.Data.Migrations
{
    ...
    [Migration("20211218202230_add_column_numofsearch")]
    partial class add_column_numofsearch
    {
            ...
            modelBuilder.Entity("Coins.Entities.Domins.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4210c407-08fa-404b-9419-139aaa853f42",
                            CreateAt = new DateTimeOffset(new DateTime(2021, 12, 18, 22, 22, 28, 865, DateTimeKind.Unspecified).AddTicks(3183), new TimeSpan(0, 2, 0, 0, 0)),
                            ...
                            PasswordHash = "ACyw1nrC3McjyfeAMfE8GIQ5nKScjg/ikxWtDqBaJXCDMluHlfkGzD5/qkd8CnZuFQ==",
