...
{
    public class StorePriceTypeRepository : Repository<StorePriceType>, IStorePriceTypeRepository
    {
        public StorePriceTypeRepository(ApplicationDbContext context)
                : base(context)
        { }

        public void Update(StorePriceType storePriceType)
        {
            Context.Update(storePriceType);
        }
