...
{
    public class UserLogsRepository : Repository<UserLogs>, IUserLogsRepository
    {
        public UserLogsRepository(ApplicationDbContext context)
                : base(context)
        { }

        public void Update(UserLogs userLog)
        {
            Context.Update(userLog);
        }
