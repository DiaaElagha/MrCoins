...
{
    public class UserVouchersRepository : Repository<UserVouchers>, IUserVouchersRepository
    {
        public UserVouchersRepository(ApplicationDbContext context)
                : base(context)
        { }

        public void Update(UserVouchers userVoucher)
        {
            Context.Update(userVoucher);
        }
    }
}
